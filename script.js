...
function end(num1, num2, num3) {
  ...
  document.getElementById('item' + num1).style.background = '#daa520';
  document.getElementById('item' + num2).style.background = '#daa520';
  document.getElementById('item' + num3).style.background = '#daa520';
